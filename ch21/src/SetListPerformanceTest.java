...
public class SetListPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Member test for tree set is " + getTestTime(set3) + " milliseconds");
        ...
        System.out.println("Member test for list is " + getTestTime(list1) + " milliseconds");
        ...
        System.out.println("Member test for linked list is " + getTestTime(list2) + " milliseconds");
